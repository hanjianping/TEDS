...
<head>
    ...
    <script type="text/javascript" src="js/historyData/hd_lean.js"></script>
        <script>
     //打印
            ...
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">受电弓倾斜</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <div class="widget-body">
                    <table class="table" style="border:0px;">
                        ...
                        <tr>
                          ...
                          <td colspan="3" style="border-top:0px;padding:0px;">
                            <a href="javascript:searchTrain()"><button  style="width:auto;margin-left:23%;"  class="btn btn-primary" title="Search">查询数据 &nbsp;<i class="icon  icon-search"></i></button></a>
								<button style="width:auto;margin-left:16%;" type="submit" class="btn btn-success" onclick="myPrint(document.getElementById('content'))" title="打印">打印列表&nbsp;<i class="icon  icon-print"></i></button>
                ...
                <table class="table table-bordered table-cell table-hover" style="margin-top:1%;">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;vertical-align: middle;">左右倾斜</th>
                        <th style="text-align: center;vertical-align: middle;">前后倾斜</th>
