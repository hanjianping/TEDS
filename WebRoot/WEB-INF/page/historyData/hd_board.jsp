...
<head>
    ...
    <script type="text/javascript" src="js/historyData/hd_board.js"></script>
     <script>
     //打印
                    ...
                    <table class="table" style="border:0px;">
                        ...
                        <tr>
                          ...
                          <td colspan="6" style="border-top:0px;padding:0px;">
							...
							<button style="width:auto;margin-left:6%;" type="submit" class="btn btn-success" onclick="myPrint(document.getElementById('content'))" title="print">打印列表&nbsp;<i class="icon  icon-print"></i></button>
