function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='Current_lean.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&lean='+lean;
	}
}
 function searchTrain(){
	 ...
	 var trainState=$('#trainState').val().trim();
      ...
      var trainId=$('#trainId').val().trim();
	window.location.href='Current_lean.action?trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&lean='+lean;
}
