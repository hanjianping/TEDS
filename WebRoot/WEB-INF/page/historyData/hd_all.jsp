...
<head>
    ...
    <script type="text/javascript" src="js/historyData/historyData.js"></script>
 <script>
     //打印
        ...
        function exportExcel(tableid) { 
            ...
            {  var trainId=$('#trainId').val().trim();
            	if(trainId !=null && trainId !=''){
            	  	tableToExcel(tableid,'name','列车编号'+trainId+'.xls') 
            	 }
        ...
        <div class="container-fluid">
            ...
            <div class="widget-body" >
                    <table class="table" style="border:0px;">
                        ...
                        <tr style="margin-bottom: 0px;padding:0px;">
                        	<td style="width:auto;">
                              ...
                              <td width="auto">
                               	<div class="control-group">
                        		<label  style="vertical-align:top;margin-top:3%;display:inline-block;">端位:</label>
                        ...
                        <tr>
                          ...
                          <td colspan="6" style="border-top:0px;padding:0px;">
                          		<a href="javascript:searchTrain()"><button  style="width:auto;margin-left:6%;"  class="btn btn-primary" title="Search">搜索数据 &nbsp;<i class="icon  icon-search"></i></button></a>
								<button style="width:auto;margin-left:6%;" type="submit" class="btn btn-success" onclick="myPrint(document.getElementById('content'))" title="打印">打印列表&nbsp;<i class="icon  icon-print"></i></button>
					
								<button style="width:auto;margin-left:6%;" type="submit" class="btn btn-info" onclick="exportExcel('content')"  title="提示:使用IE浏览器,要启用未标记的安全Active控件" >导出数组&nbsp;<i class="icon  icon-external-link"></i></button>
                          </td>
                        </tr>
                           ...
                           <c:set var="trainId" value="${train.trainId}"/>
                            ...
                            <c:choose>  
                        		<c:when test="${train.firstLeft >firstLeftThreshold}">
                           		  	<td class="exception" style="font-weight:bold;">
                            			${train.firstLeft}
                            		</td>
                    			</c:when>
                    			<c:otherwise>
                ...
                <div class="pagin">
               	...
               	<div style="background-image: url(images/train.jpg );background-repeat:no-repeat; background-position:left;
                width:100%;height:108px;">
