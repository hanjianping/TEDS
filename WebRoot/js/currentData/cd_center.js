function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='Current_line.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&line='+line;
	}
}
 function searchTrain(){
	...
	window.location.href='Current_line.action?trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&line='+line;
}
