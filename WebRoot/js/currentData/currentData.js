function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='Current_all.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState;
	}
}
 function searchTrain(){
	 ...
	 var trainState=$('#trainState').val().trim();
      var trainId=$('#trainId').val().trim();
	window.location.href='Current_all.action?trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState;
}
