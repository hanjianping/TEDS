...
<head>
   ...
   <script type="text/javascript" src="js/analyseData/abrasion.js"></script>
...
<div id="container" class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">磨损统计</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
  ...
  <script>
            ...
            AmCharts.ready(function () {
                ...
                graph1.bulletSize = 7;
                graph1.title = "碳滑板二";
                graph1.valueField = "secondLeft";
                graph1.lineThickness = 2;
                graph1.lineColor = "orange";
                graph1.legendValueText = " [[value]] mm";
                graph1.legendPeriodValueText = "[[value]] mm";
