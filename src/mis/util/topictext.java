...
public class topictext extends JFrame {  
    // 添加属性  
    ...
    public topictext(String str) {  
        ...
        button_color.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                Color color;  
                color=JColorChooser.showDialog(topictext.this,"颜色选择", Color.black);  
    ...
    private void addmyMenu() {// 添加主菜单、快捷菜单、对话框  
        ...
        menuitem_open.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                ...
                int result = filechooser.showOpenDialog(topictext.this);  
                if (result == JFileChooser.APPROVE_OPTION) {  
                    try {  
                        ...
                        JOptionPane.showMessageDialog(topictext.this,"打开文档出错！");  
                    }  
                }  
            }  
        });  
        ...
        menuitem_save.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                JFileChooser filechooser = new JFileChooser();  
                int result = filechooser.showSaveDialog(topictext.this);  
                if (result == JFileChooser.APPROVE_OPTION) {  
                    try {  
                        File file = filechooser.getSelectedFile();  
        ...
        menuitem_countwordsnum.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                ...
                JOptionPane.showMessageDialog(topictext.this, "文本框中一共有"+count+"个字符！");  
            }  
        });  
        ...
        menuitem_replace.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                String str_replace=JOptionPane.showInputDialog(topictext.this,  
                        "请输入你要替换的字符串:" );  
                String str_replacelater=JOptionPane.showInputDialog(topictext.this,  
                        "请输入你要用来替换的内容:" );  
        ...
        menuitem_about.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                JOptionPane.showMessageDialog(topictext.this,"文本编辑器v1.0   开发者：hhtx");  
            }  
        });  
        ////////////////////////////////////////////////// 快捷菜单对象  
    ...
    private class MessageJDialog extends JDialog {  
        ...
        public MessageJDialog() {  
            super(topictext.this, "查找");  
            this.setSize(300, 170);  
            this.setLocation(topictext.this.getX() + 200,  
            		topictext.this.getY() + 200);  
