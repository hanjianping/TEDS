function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='History_board.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate+'&duanNo='+duanNo+'&planeNo='+planeNo;
	}
}
 function searchTrain(){
	 ...
	 var duanNo=$("#duanNo").val();
	  ...
	  var lastDate =$("#lastDate").val();
      var trainId=$('#trainId').val().trim();
  	window.location.href='History_board.action?trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate+'&duanNo='+duanNo+'&planeNo='+planeNo;
}
