function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='History_lean.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate;
	}
}
 function searchTrain(){
	 if(document.getElementById("checkflag").checked){
	  ...
	  var lastDate =$("#lastDate").val();
      var trainId=$('#trainId').val().trim();
  	window.location.href='History_lean.action?trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate;
}
