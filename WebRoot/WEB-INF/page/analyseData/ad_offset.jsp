...
<head>
   ...
   <script type="text/javascript" src="js/analyseData/offset.js"></script>
...
<div id="container" class="row-fluid">
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">偏移统计</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
                        	...
                        	<td style="width:auto;">
                              ...
                              <td width="auto">
                                ...
                                <select class="chosen"  id="duanNo"  style="width:auto;" >
                                      ...
                                      <option value="${duanNo}" <c:if test="${duanNo eq train.trainId}">selected="selected"</c:if>>${duanNo}</option>
                                     </c:forEach>
                                  </select>
                                  </div>
                              </td>
            ...
            var average = ${centerBiaseThreshold};
            ...
            AmCharts.ready(function () {
                ...
                valueAxis.title = "碳 滑 板 中 心 线 偏 移";
                ...
                guide.dashLength = 4;
                guide.label = "警戒线"+${centerBiaseThreshold}+"mm";
                guide.inside = true;
                guide.lineAlpha = 2;
                ...
                graph.bulletSize = 7;
                graph.title = "中心线偏移";
                graph.balloonText="中心线偏移:[[value]] mm";
                graph.valueField = "centerBiase";
