...
<head>
    ...
    <script type="text/javascript" src="js/currentData/cd_lean.js"></script>
    <script>
     //打印
    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="widget-body">
                    <table class="table" style="border:0px;">
                        ...
                        <tr>
                          <td colspan="3" style="border-top:0px;padding:0px;">
                           		 <a href="javascript:searchTrain()"><button style="width:auto;margin-left:33%;" type="submit" class="btn btn-warning"  title="Search" >搜索数据&nbsp;<i class="icon  icon-search"></i></button></a>
                ...
                <table class="table table-bordered table-cell table-hover" style="margin-top:2%;">
                    <thead>
                    <tr>
               ...
               <div class="pagin">
                    <div class="message">共&nbsp;<i class="blue">${pageBean.recordCount }</i>&nbsp;条记录，当前显示第&nbsp;
                    	...
                    	<ul class="paginList">
                        	<li class="paginItem">
                        		<a class="pagepre" href="javascript:gotoDemandPage(${pageBean.currentPage - 1})"></a>
                        	</li>
