...
<head>
    ...
    <script type="text/javascript" src="js/historyData/hd_press.js"></script>
        <script>
     //打印
            ...
            <div class="widget-body">
                    <table class="table" style="border:0px;">
                        ...
                        <tr>
                           ...
                           <td colspan="3" style="border-top:0px;padding:0px;">
								...
								<button style="width:auto;margin-left:16%;" onclick="myPrint(document.getElementById('content'))" type="submit" class="btn btn-success" title="Search">打印列表&nbsp;<i class="icon  icon-print"></i></button>
                          </td>
                        </tr>
                ...
                <table class="table table-bordered table-cell table-hover" style="margin-top:1%;">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;vertical-align: middle;">弓网压力</th>
