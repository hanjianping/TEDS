function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='History_all.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate+'&duanNo='+duanNo+'&planeNo='+planeNo;
	}
}
 function searchTrain(){
	 ...
	 var duanNo=$("#duanNo").val();
	  ...
	  var lastDate =$("#lastDate").val();
      var trainId=$('#trainId').val().trim();
  	window.location.href='History_all.action?trainId='+trainId+'&checkflag='+checkflag+'&firstDate='+firstDate+'&lastDate='+lastDate+'&duanNo='+duanNo+'&planeNo='+planeNo;;
}
