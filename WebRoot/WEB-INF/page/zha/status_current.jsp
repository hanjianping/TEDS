...
<head>
    ...
    <script type="text/javascript" src="js/deviceStatus/status_current.js"></script>
 <script>
     //打印
            ...
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">系统当日状态</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <div class="widget-body" id="dddd">
                    <table class="table" style="border:0px;">
                        ...
                        <tr style="margin-bottom: 0px;padding:0px;">
                            ...
                            <td width="auto;">
                               <a href="javascript:searchTrain()"><button  style="width:auto;margin-top:1%;"  class="btn btn-primary" title="Search">查询数据 &nbsp;<i class="icon  icon-search"></i></button></a>
								<button style="width:auto;margin-left:6%;" onclick="myPrint(document.getElementById('content'))"   type="submit" class="btn btn-success" title="打印" >打印列表&nbsp;<i class="icon  icon-print"></i></button>
                          </td>
                        </tr>
