...
<head>
    ...
    <script type="text/javascript" src="js/historyData/hd_line.js"></script>
        <script>
     //打印
            ...
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">中心线偏移</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <div class="widget-body">
                    <table class="table" style="border:0px;">
                        ...
                        <tr>
                          ...
                          <td colspan="3" style="border-top:0px;padding:0px;">
                                <a href="javascript:searchTrain()"><button  style="width:auto;margin-left:28%;"  class="btn btn-primary" title="Search">查询数据 &nbsp;<i class="icon  icon-search"></i></button></a>
								<button style="width:auto;margin-left:16%;" type="submit" onclick="myPrint(document.getElementById('content'))" class="btn btn-success" title="Search">打印列表&nbsp;<i class="icon  icon-print"></i></button>
                          </td>
                        </tr>
                ...
                <table class="table table-bordered table-cell table-hover" style="margin-top:1%;">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;vertical-align: middle;">中心线偏移</th>
