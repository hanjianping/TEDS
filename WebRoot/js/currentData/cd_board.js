function gotoDemandPage(num){
	...
	if(num>0){
		window.location.href='Current_board.action?pageCode='+num+'&trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&board='+board;
	}
}
 function searchTrain(){
	...
	window.location.href='Current_board.action?trainId='+trainId+'&checkflag='+checkflag+'&trainState='+trainState+'&board='+board;
}
