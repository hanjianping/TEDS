...
<head>
   ...
   <script type="text/javascript" src="js/analyseData/press.js"></script>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                width:100%;height:108px;">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">压力统计</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            ...
            AmCharts.ready(function () {
                ...
                valueAxis.title = "碳 滑 板 接 触 压 力 单 位 (N)";
                ...
                guide.dashLength = 4;
                guide.label = "警戒线"+${pressThreshold}+"N";
                guide.inside = true;
                guide.lineAlpha = 2;
                ...
                graph.bulletSize = 7;
                graph.title = "碳滑板接触压力";
                graph.balloonText="压力:[[value]] N";
                graph.valueField = "press";
                graph.lineThickness = 2;
                graph.lineColor = "#00BBCC";
                graph.legendValueText = " [[value]] N";
                graph.legendPeriodValueText = "[[value]] N";
